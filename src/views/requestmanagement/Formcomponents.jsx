            ...
            <div className="form-left">
                ...
                <div className="form-group">
                    ...
                    {readOnly ? (
                        <div className="form-value">
                            {request.gso_service
                                ? request.gso_service.vehicle.vehicleID
                                : "---"}
                        </div>
                    ) : (
                        <input
        ...
        <div className="form-grid">
            ...
            <div className="form-right">
                ...
                <div className="form-group">
                    <div className="form-label">Date Needed:</div>
                    <div className="form-value">
                        {request.activityDateStart}
                    </div>
                </div>

                <div className="form-group">
                    <div className="form-label">Activity Date Start:</div>
                    {readOnly ? (
                        <div className="form-value">
                ...
                <div className="form-group">
                    <div className="form-label">Activity Date End:</div>
                    {readOnly ? (
                        <div className="form-value">
                            {/* {formattedDate.start.time +
                                " - " +
                ...
                <div className="form-group">
                    ...
                    {/*  JSON.stringify line if it's only for debugging /}
                    {/* {JSON.stringify(request.materials)} */}
                    {readOnly ? (
                ...
                <table className="particulars-table">
                    <thead>
                        <tr>
                            ...
                            <th className="particulars-header">Remarks</th>
                        </tr>
                    </thead>
                    <tbody>
                        {request.joblist.map((item, index) => (
                            <tr key={index}>
